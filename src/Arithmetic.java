public class Arithmetic {
    ///**
    // * Используя арифметические операторы (+, -, *, /, div, mod), а также функции round(), trunc() и abs(),
    ...
    // * 10. Та же ситуация, что и в предыдущей задаче.
    ...
    public static void main(String [] args ) {
        ...
        int flats = 4;
        int number = 5;
        int entrance = number - 1 / ((floors * flats + 1));
        ...
        double z = 0.9;
        n = 50;
        System.out.println((int)Math.floor((z*n)/y+1));
